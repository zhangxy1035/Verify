...
public class GeetestLib {
	...
	protected final String sdkLang = "java";// SD的语�?���?
	 ...
	 * 
	 * @param getURL
	 * @return 服务器返回结�?	 * @throws IOException
	 */
	private String readContentFromGet(String getURL) throws IOException {
		...
		connection.setConnectTimeout(2000);// 设置连接主机超时（单位：毫秒�?		connection.setReadTimeout(2000);// 设置从主机读取数据超时（单位：毫秒）
